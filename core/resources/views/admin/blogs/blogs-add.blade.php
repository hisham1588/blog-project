    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Create Your Blog</li>
            </ol>

            <div>
                <div class="d-flex justify-content-end">
                    <a href="{{ route('view.blog') }}" class="btn btn-success">back</a>
                </div>
                ...
                <div class="bg-white shadow rounded p-2 w-75 mx-auto">
                    <form action="{{ route('store.blog') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="dec" name="dec" rows="4" required></textarea>
                        </div>
                        <div class="mb-3">
